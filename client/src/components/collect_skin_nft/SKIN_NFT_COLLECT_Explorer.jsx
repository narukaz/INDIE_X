...
function SKIN_NFT_COLLECT_Explorer() {
  let navigate = useNavigate();
  return (
    <>
      <div
        onClick={() => {
          navigate("/collect-skin-nft/nft");
        }}
        className="relative shadow-md px-9 py-8 overflow-hidden gap-4  bg-black flex"
      >
        <div className=" flex flex-col border rounded-2xl border-gray-500 overflow-hidden ">
          <div className="flex items-center gap-4 w-full">
            ...
            />
            <label className="inline-flex items-center cursor-pointer gap-2 flex-shrink-0 px-4 border-b border-b-gray-500 py-3">
...
export default SKIN_NFT_COLLECT_Explorer;
