...
import SKIN_NFT_COLLECT_Explorer from "../collect_skin_nft/SKIN_NFT_COLLECT_Explorer";

function NFT_SKIN_ORIGIN_SCREEN({ Game_Title, Game_Rating }) {
  return (
    <div className="flex flex-col gap-5 w-full ">
      ...
      <div
        className="flex w-full gap-4 px-8"
...
export default NFT_SKIN_ORIGIN_SCREEN;
