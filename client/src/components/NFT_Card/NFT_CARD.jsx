...
function NFT_CARD({
  ...
  return (
    <div
      className="rounded-2xl  group bg-gradient-to-b from-[#0E1420] to-[#121926]
                     max-w-[400px] h-auto aspect-[9.5/12.5] p-1 flex flex-col items-start
                     border border-solid border-blue-300 overflow-hidden cursor-pointer hover:scale-105 transition-all "
    >
      ...
      >
        ...
        <div
          className="absolute right-0 w-full h-full
                         ...
                         gap-2 p-6 group-hover:bottom-0 -bottom-48
                         "
        >
          ...
          <div className="flex flex-col items-start w-full  justify-start gap-2 pl-4 py-1 bg-white text-gray-700 rounded-2xl font-normal select-none">
